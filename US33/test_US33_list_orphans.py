...
class TestUS33_list_orphans(unittest.TestCase):
    ...
    def test_input_data1(self,mock_print):
        list_indi, list_fam = parse("/home/chinmay/Coding/Courses/CS555_WS4_Agile/Group_4_Assignment/US33/recent_orphans.ged")
        ...
        mock_print.assert_called_with([('I3', 14, ' Mehul /Das/')])
